...
public interface UserService extends CoreService<TbUser> {
	...
	Map<String, Object> findFootMark(String username, List<Long> markList);

    void addFootMark(String username, List<Long> markList);

    List<Long> getMarkListFromRedis(String username);
