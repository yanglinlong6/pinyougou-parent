                ...
                <div class="fl preview-wrap">
                    ...
                    <div class="zoom">
                        ...
                        <div id="preview" class="spec-preview">
                            <span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}"
                        ...
                        <div class="spec-scroll">
                            ...
                            <div class="items">
                                ...
                                <#list imageList as image>
                                    <li><img src="${image.url}" bimg="${image.url}" width="400px" height="400px"
                            ...
                            <#-- <a href="javascript:;" class="selected">金色<span title="点击取消选择">&nbsp;</span></a>-->
                               <#list specification.attributeValue as value>
                                    <dd><a href="javascript:;"
                                           :class="{selected:isSelected('${specification.attributeName}','${value}')}"
                                           @click="selectSpecifcation('${specification.attributeName}','${value}')">${value}
                        ...
                        <div class="summary-wrap">
                            <div class="fl title">
                                <div class="control-group">
                                    <div class="controls">
                                        <input autocomplete="off" v-model="num" type="text" value="1" minnum="1"
                                               class="itxt"/>
                            ...
                            <div class="fl">
                                <ul class="btn-choose unstyled">
                                    <li>
                                        <a href="#" @click="addGoodsToCartList()"
                ...
                <div class="fr detail">
                    ...
                    <div class="tab-main intro">
                        ...
                        <div class="tab-content tab-wraped">
                            ...
                            <#list customAttributeList as custom>
                                <p>${custom.text}:${custom.value}</p>
                            </#list>
                            </div>
                        </div>
                    </div>
